    ...
    class UserDAO implements UserDAOInterface{
        ...
        public function verificToken($protected = false){
            if(!empty($_SESSION["token"])){
                ...
                $this->message->setMessage("Faça a verificação para acessar essa página!", "error", "index.php");
                }
        ...
        public function authenticateUser($email, $passaword){
            ...
            if ($user){
                // Checar a senhas se são iguais
                if (password_verify($passaword, $user->password)){
